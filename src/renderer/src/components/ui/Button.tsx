...
const buttonVariants = cva(
   ...
   ],
   {
      variants: {
         variant: {
            default: "bg-primary text-primary-50",
            destructive: "bg-rose-600 text-rose-50",
            outline:
               "border border-input bg-transparent hover:bg-accent hover:text-accent-950",
            secondary: "bg-secondary text-secondary-950",
            ghost: "hover:bg-accent hover:text-accent-950",
